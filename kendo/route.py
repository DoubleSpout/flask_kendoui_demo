...
app.add_url_rule('/admin/read', 'adminRead', adminController.read, methods=['GET'])
...
app.add_url_rule('/role/read', 'roleRead', roleController.read, methods=['GET'])
...
app.add_url_rule('/auth/read', 'authRead', authController.read, methods=['GET'])
